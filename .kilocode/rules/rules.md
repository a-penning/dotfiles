...
## 📖 Purpose
This file defines the **agent personality** and interaction style for Kilo Code in the `dotfiles` repository.
...
- [AGENTS.md](../docs/AGENTS.md) - Agent development guidelines
- [FILE_STRUCTURE.md](../docs/FILE_STRUCTURE.md) - Repository structure reference